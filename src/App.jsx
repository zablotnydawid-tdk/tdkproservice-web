...
function KodeksOnlinePage() {
  usePageMeta({
    ...
    description: 'Wstępna ocena systemu OZE za 149,99 zł. Screening techniczno-energetyczny na podstawie danych użytkownika, obsługiwany przez system KODEKS.',
